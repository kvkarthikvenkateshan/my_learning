...
class initi(Thread):
    ...
    def __init__(self,root):
        ...
        self.mbut = Button(frame,text='Exit',command=frame.quit,bg='green',fg='white')
        self.mbut.grid(row=1,column=2)
        self.mbut.config(width=15)

        self.mbut1 = Button(frame,text='Send Message',command=self.send,bg='green',fg='white')
        ...
        self.txtbox = Text(frame,height=30,width=60,wrap=WORD)
